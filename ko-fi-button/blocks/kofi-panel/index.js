...
/***/ "./block-src/kofi-panel/block.json"
/*!*****************************************!*\
  !*** ./block-src/kofi-panel/block.json ***!
  \*****************************************/
(module) {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ko-fi-button/kofi-panel","version":"1.3.10","title":"Ko-fi Donate Panel","category":"widgets","description":"Display a donate panel.","example":{},"attributes":{"code":{"type":"string"}},"supports":{"html":false},"textdomain":"ko-fi-button","editorScript":["file:./index.js"],"editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');

/***/ },

/***/ "./block-src/kofi-panel/edit.js"
/*!**************************************!*\
  !*** ./block-src/kofi-panel/edit.js ***!
  \**************************************/
...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editor.scss */ "./block-src/kofi-panel/editor.scss");
...
/***/ "./block-src/kofi-panel/editor.scss"
/*!******************************************!*\
  !*** ./block-src/kofi-panel/editor.scss ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./block-src/kofi-panel/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./block-src/kofi-panel/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./block-src/kofi-panel/block.json");
/* harmony import */ var _transforms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./transforms */ "./block-src/kofi-panel/transforms.js");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react/jsx-runtime */ "react/jsx-runtime");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__);
/**
...
/***/ "./block-src/kofi-panel/style.scss"
/*!*****************************************!*\
  !*** ./block-src/kofi-panel/style.scss ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./block-src/kofi-panel/transforms.js"
/*!********************************************!*\
  !*** ./block-src/kofi-panel/transforms.js ***!
  \********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const transformers = {
  ...
  from: [{
    ...
    transform: ({
      ...
      let shortcodeObj = (0,_wordpress_shortcode__WEBPACK_IMPORTED_MODULE_1__.next)('kofi', text);
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ko-fi-button/kofi-panel', shortcodeObj.shortcode.attrs.named);
    }
  }, {
    type: 'shortcode',
    tag: 'kofi',
    ...
    transform: ({
      ...
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ko-fi-button/kofi-panel', named);
    }
  }, {
    type: 'block',
    ...
    transform: ({
      ...
      return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('ko-fi-button/kofi-panel', {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["kofi-panel/style-index"], () => (__webpack_require__("./block-src/kofi-panel/index.js")))
